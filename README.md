...
* Определение основных средств автоматизации
  ...
  - Определение конфигурации программных средств - двухуровневая конфигурация: ОС Windows/Linux/IOS/Android/др для рабочих станций, ОС Linux для сервера. Для станций сотрудников деканата также ПО для подключения к серверу (например, FileZilla).
